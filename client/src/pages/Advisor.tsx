  ...
  return (
    <div className="space-y-6">
      <section className="rounded-lg border border-gray-200 dark:border-gray-700 p-4">
        <h2 className="mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">This month's nudges</h2>
        <ul className="space-y-2 text-sm">
          {nudges.map((n, i) => (
            <li key={i} className="rounded bg-purple-50 dark:bg-purple-950 p-2 text-purple-900 dark:text-purple-200">
              {n}
            </li>
          ))}
        </ul>
      ...
      <section className="rounded-lg border border-gray-200 dark:border-gray-700 p-4">
        <h2 className="mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">Investment reallocation suggestions</h2>
        {suggestions.length === 0 && <p className="text-xs text-gray-400 dark:text-gray-500">No reallocation suggestions right now.</p>}
        <ul className="space-y-2 text-sm">
          {suggestions.map((s, i) => (
            <li key={i} className="rounded bg-amber-50 dark:bg-amber-950 p-2 text-amber-900 dark:text-amber-200">
